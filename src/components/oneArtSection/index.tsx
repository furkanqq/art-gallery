...
const OneArtSection = ({
  ...
  return (
    <Section className="!sticky top-0 z-0 shadow-3xl" key={key}>
      ...
      <motion.div
        ...
        className={`absolute items-center bg-${props.descriptionColor} w-screen h-screen left-[-99.5vw] cursor-pointer after:content-['']  after:w-[28px] after:h-[28px] after:absolute after:right-[-12px] after:rotate-[45deg] after:top-[50%] after:-translate-y-1/2 after:z-10 after:bg-${props.descriptionColor} before:content-['Pull'] before:text-dirty_white before:opacity-50  before:w-fit  before:h-[28px] before:absolute before:right-[-50px] before:top-[50.3%] before:-translate-y-1/2 before:z-10`}
      >
        <div
